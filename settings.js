...
global.mess = {
    success: '✉️✏️ _Done_',
    admin: '✉️✏️ _Este recurso é apenas para administradores!_',
    botAdmin: '✉️✏️ _O bot deve ser administrador primeiro!_',
    owner: '✉️✏️ _Este recurso é apenas para o proprietário!_',
    group: '✉️✏️ _Recurso usado apenas para grupos!_',
    private: '✉️✏️ _Recursos usados apenas para bate-papo privado!_',
    bot: '✉️✏️ _Este recurso é apenas para bot_',
    wait: '✉️✏️ _Processando ... Por favor aguarde..._',
    linkm: '📧✏️ _Onde está o link?_',
    error: '✉️🤕 ```Erro!!```',
